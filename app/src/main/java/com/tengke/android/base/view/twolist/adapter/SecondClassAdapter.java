...
import com.tengke.android.base.view.twolist.model.SecondClassItem;
...
public class SecondClassAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.two_list_right_listview_item, null);
