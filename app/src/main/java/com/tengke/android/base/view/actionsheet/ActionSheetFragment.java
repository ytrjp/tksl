package com.tengke.android.base.view.actionsheet;

/**
 * Created by jinpeng on 16/9/22.
 */
...
public class ActionSheetFragment extends Fragment {
    ...
    public static ActionSheetFragment newItemInstance(String title, String[] items, boolean visiable) {
        ActionSheetFragment fragment = new ActionSheetFragment();
        Bundle bundle = new Bundle();
        bundle.putString("title", title);
        bundle.putStringArray("items", items);
        bundle.putInt("type", 1);
        bundle.putBoolean("visiable", visiable);
    ...
    private void initViews(View view) {
        ...
        if (getArguments().getInt("type") == 1) {
            boolean isShow = getArguments().getBoolean("visiable");
            TextView pop_cancel = (TextView) view.findViewById(R.id.pop_cancel);
            pop_cancel.setVisibility(isShow ? View.VISIBLE: View.GONE);
    ...
    public static class Builder {
        ...
        public Builder setVisiable(boolean visiable) {
            enVisiable = visiable;
            return this;
        }
        ...
        public void show() {
            ...
            if (choice == CHOICE.ITEM) {
                fragment = ActionSheetFragment.newItemInstance(title, items, enVisiable);
