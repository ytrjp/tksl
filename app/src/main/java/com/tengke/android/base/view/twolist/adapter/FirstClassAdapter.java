package com.tengke.android.base.view.twolist.adapter;
...
import com.tengke.android.base.view.twolist.model.FirstClassItem;
...
public class FirstClassAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.two_list_left_listview_item, null);
        ...
        if (list.get(position).getSecondList() != null && list.get(position).getSecondList().size() > 0) {
            holder.nameTV.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_launcher, 0);
        } else {
